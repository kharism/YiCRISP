...
class SchoolCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_of_school', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			array('category_of_school', 'length', 'max'=>16),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, category_of_school', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'category_of_school' => 'Category Of School',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('category_of_school',$this->category_of_school,true);

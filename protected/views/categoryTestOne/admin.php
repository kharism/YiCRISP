...
$('.search-form form').submit(function(){
	$('#category-test-one-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Category Test Ones</h1>
	...
	'columns'=>array(
		...
		array(
			...
			'buttons'=>array(
				'logs'=>array(
					'label'=>'',
					'url'=>'Yii::app()->createUrl("log/viewLog",array("model"=>"CategoryTestOne","model_id"=>$data->id))',
					'options'=>array(

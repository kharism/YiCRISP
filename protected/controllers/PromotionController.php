...
class PromotionController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','admin','delete','create','list','update'),
				'roles'=>array('admin'),
			),
			array('allow',
				'actions'=>array('get'),
	...
	public function actionGet($id){
	    ...
	    foreach($promotion as $item){
			$promotions[$item->id] = $item->getPriceGrade($id);
		}
		echo "<div id='ppp1'>".CJSON::encode($promotions)."</div>";
		echo "<div id='ppp2'>".Helper::getConfig('tuition'.$id)."</div>";
